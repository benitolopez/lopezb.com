...
export default function Navigation() {
  return (
    <header className="border-b py-4">
      <div className="container mx-auto px-6 md:px-8 lg:px-12 max-w-[40rem] sm:flex justify-between items-center">
        <Link
          href="/"
          className="order-2 border-b block pt-2 pb-4 mb-4 sm:p-0 sm:m-0 sm:border-0"
        >
          <span className="text-black font-bold font-sans">Benito Lopez</span>
        </Link>
