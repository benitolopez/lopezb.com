...
export default function NewsletterForm() {
  ...
  return (
    <>
      <div className="bg-black mt-12 mb-5 p-12 rounded-md">
        ...
        <form action={action}>
          ...
          <input
            ...
            id="email"
            required
            className="block w-full py-2 px-5 text-gray-800 placeholder:text-gray-400 rounded-md bg-white focus:outline-gray-400 outline-offset-0"
          ...
          <button
            type="submit"
            className="mt-4 w-full py-3 px-5 rounded-md hover:bg-white hover:text-black focus:outline-none text-left bg-blue-500 text-white"
          >
            Subscribe
          </button>
