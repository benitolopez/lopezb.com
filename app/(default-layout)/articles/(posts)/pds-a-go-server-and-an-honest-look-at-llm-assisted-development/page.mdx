...
export const metadata = {
  title:
    "Limite: A Go Server And An Honest Look At LLM-Assisted Development - Benito Lopez",
  description:
...
_This project was originally called **PDS**. It has since been renamed to **Limite** to better reflect its purpose as a bounded-memory infrastructure system. All concepts and code remain the same._

---

In these hours I've published <del>PDS</del> [Limite](https://github.com/benitolopez/limite), a standalone server written in Go that offers probabilistic data structures. You can find it here. In-memory, of course, which accepts commands via TCP through Redis's RESP protocol and offers a very simple API. Using RESP turned out to be a very convenient choice, since I avoided having to create a dedicated CLI and automatically made this project compatible with every Redis client.
...
<Image
  ...
  width="1512"
  height="542"
  className="mb-5 mx-auto border"
  alt="Limite vs Redis benchmarks (Key-value commands)"
/>
...
<Image
  ...
  height="386"
  className="mb-5 mx-auto border"
  alt="Limite vs Redis benchmarks (HyperLogLog commands)"
/>
...
<Image
  ...
  height="448"
  className="mb-5 mx-auto border"
  alt="Limite vs Redis benchmarks (Bloom filter commands)"
/>
...
<Image
  ...
  height="278"
  className="mb-5 mx-auto border"
  alt="Limite vs Redis benchmarks (Count-Min Sketch commands)"
/>
...
<Image
  ...
  height="440"
  className="mb-5 mx-auto border"
  alt="Limite vs Redis benchmarks (Top-K commands)"
/>
