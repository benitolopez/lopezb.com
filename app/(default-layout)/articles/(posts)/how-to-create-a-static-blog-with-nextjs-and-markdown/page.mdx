...
export const metadata = {
  title:
    "How To Create A Simple Static Blog With Next.js And Markdown - Benito Lopez",
  description:
...
<Title title={metadata.title} date={metadata.date} id="introduction" />
...
<Toc
  ...
  items={[
    ...
    },
    {
      ...
      id: "setting-up-the-nextjs-project",
    },
    {
      title: "Integrating MDX for markdown content",
      id: "integrating-mdx-for-markdown-content",
    },
    {
      title: "Setting up routing for articles and categories",
      id: "setting-up-routing-for-articles-and-categories",
      items: [
    ...
    {
      title: "Adding syntax highlighting with Rehype Pretty Code",
      id: "adding-syntax-highlighting-with-rehype-pretty-code",
    },
    { title: "Conclusion", id: "conclusion" },
  ]}
/>

Although there are more immediate [solutions](https://wordpress.org/) for
creating a blog, I have always been fascinated by static site generators,
especially for this type of application: they are easy to maintain and
generally perform well. Of course, the world is full of such tools, and I have
no reason to prefer [Next.js](nextjs.org/) to [Hugo](https://gohugo.io/),
[Astro](https://astro.build/), etc. And probably Next.js is slightly overkill
for just a static blog.
...
So, what features are we going to discuss? As per the title, the blog will be static using Next.js (App Router). Thanks to [MDX](https://mdxjs.com/), posts can be written in Markdown. Finally, we will use [Rehype Pretty Code](https://rehype-pretty.pages.dev/) for syntax highlighting.
