...
The problem is, I have so many passions and habits, and very little time for all of them. So I need to find a balance. Writing is good, keeping up a blog is fine, but I can't spend days on a single post like I did, for instance, with the article on <Link className="text-gray-950 underline underline-offset-4 decoration-1 decoration-gray-400" href="/articles/how-to-create-a-static-blog-with-nextjs-and-markdown">Next.js</Link>. I just can't afford that if I want to keep feeding my other passions. At least not always.
